...
const otherServers = [
    ...
    'bz-blp.prod.surfshark.com:80', 'bt-pbh.prod.surfshark.com:80', 'bo-sre.prod.surfshark.com:80',
    'ba-sjj.prod.surfshark.com:80', 'br-sao.prod.surfshark.com:80', 'bn-bwn.prod.surfshark.com:80',
    'bg-sof.prod.surfshark.com:80', 'kh-pnh.prod.surfshark.com:80', 'cl-san.prod.surfshark.com:80',
    'co-bog.prod.surfshark.com:80', 'cr-sjn.prod.surfshark.com:80', 'hr-zag.prod.surfshark.com:80',
    'cy-nic.prod.surfshark.com:80', 'cz-prg.prod.surfshark.com:80', 'dk-cph.prod.surfshark.com:80',
    'ec-uio.prod.surfshark.com:80', 'eg-cai.prod.surfshark.com:80', 'ee-tll.prod.surfshark.com:80',
    'fi-hel.prod.surfshark.com:80', 'ge-tbs.prod.surfshark.com:80', 'gh-acc.prod.surfshark.com:80',
    'gr-ath.prod.surfshark.com:80', 'gl-goh.prod.surfshark.com:80', 'hk-hkg.prod.surfshark.com:80',
    'hu-bud.prod.surfshark.com:80', 'is-rkv.prod.surfshark.com:80', 'id-jak.prod.surfshark.com:80',
    'ie-dub.prod.surfshark.com:80', 'im-iom.prod.surfshark.com:80', 'il-tlv.prod.surfshark.com:80',
    'jp-tok.prod.surfshark.com:80', 'kz-ura.prod.surfshark.com:80', 'la-vte.prod.surfshark.com:80',
    'lv-rig.prod.surfshark.com:80', 'li-qvu.prod.surfshark.com:80', 'lt-vno.prod.surfshark.com:80',
    'lu-ste.prod.surfshark.com:80', 'mo-mfm.prod.surfshark.com:80', 'my-kul.prod.surfshark.com:80',
    'mt-mla.prod.surfshark.com:80', 'mx-qro.prod.surfshark.com:80', 'md-chi.prod.surfshark.com:80',
    'mc-mcm.prod.surfshark.com:80', 'mn-uln.prod.surfshark.com:80', 'me-tgd.prod.surfshark.com:80',
    'ma-rab.prod.surfshark.com:80', 'mm-nyt.prod.surfshark.com:80', 'np-ktm.prod.surfshark.com:80',
    'nl-ams.prod.surfshark.com:80', 'nz-akl.prod.surfshark.com:80', 'ng-lag.prod.surfshark.com:80',
    'mk-skp.prod.surfshark.com:80', 'no-osl.prod.surfshark.com:80', 'pk-khi.prod.surfshark.com:80',
    'pa-pac.prod.surfshark.com:80', 'py-asu.prod.surfshark.com:80', 'pe-lim.prod.surfshark.com:80',
    'ph-mnl.prod.surfshark.com:80', 'pr-sju.prod.surfshark.com:80', 'ro-buc.prod.surfshark.com:80',
    'sa-ruh.prod.surfshark.com:80', 'rs-beg.prod.surfshark.com:80', 'sg-sng.prod.surfshark.com:80',
    'sk-bts.prod.surfshark.com:80', 'si-lju.prod.surfshark.com:80', 'za-jnb.prod.surfshark.com:80',
    'kr-seo.prod.surfshark.com:80', 'lk-cmb.prod.surfshark.com:80', 'se-sto.prod.surfshark.com:80',
...
async function fillMedicareForm(page, urlIndex) {
    try {
        ...
        console.log(`  -> [Tab ${urlIndex + 1}] Form loaded! Starting to fill data...`);
        ...
        console.log(`  -> [Tab ${urlIndex + 1}] SUCCESS: Form fully submitted.`);

    } catch (err) {
        console.log(`  -> [Tab ${urlIndex + 1}] ERROR inside form fill: ${err.message}`);
    }
}
        ...
        try {
            const loopLogic = async () => {
                ...
                context = await browser.newContext({
                    proxy: {
                        // Dynamically swaps to the standard HTTP proxy fallback port
                        server: `http://${proxyServer.replace(':80', ':8080')}`,
            ...
            if (context) {
                console.log(`[System] Closing context, wiping cache/cookies...`);
